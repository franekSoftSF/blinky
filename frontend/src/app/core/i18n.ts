...
const messages = {
  pl: {
    ...
    configuration:'KONFIGURACJA',consoleSettings:'Ustawienia konsoli',settingsText:'Dane sesji operatora i informacje o połączeniu.',operatorAccess:'Dostęp operatora',operatorHelp:'Token jest przechowywany wyłącznie w pamięci sesji przeglądarki. Zamknięcie karty go usuwa.',operatorToken:'Token operatora',enterToken:'Wprowadź token…',saveConnect:'Zapisz i połącz',about:'O aplikacji',aboutText:'Blinky Console · Angular 22 · połączenie z API przez ten sam origin.',openSource:'Open source',language:'Język',credentialConsole:'Konsola poświadczeń'
  },
  en: {
