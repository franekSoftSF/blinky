...
const messages = {
  pl: {
    ...
    configuration:'KONFIGURACJA',consoleSettings:'Ustawienia konsoli',settingsText:'Dane sesji operatora i informacje o połączeniu.',operatorAccess:'Dostęp operatora',operatorHelp:'Token jest przechowywany wyłącznie w pamięci sesji przeglądarki. Zamknięcie karty go usuwa.',operatorToken:'Token operatora',enterToken:'Wprowadź token…',saveConnect:'Zapisz i połącz',about:'O aplikacji',aboutText:'Blinky Console · Angular 22 · połączenie z API przez ten sam origin.',openSource:'Open source',language:'Język',credentialConsole:'Konsola poświadczeń',actions:'Akcje',recycle:'Wycofaj i wyczyść slot',recycleConfirm:'Certyfikat zostanie wycofany, a agent usunie certyfikat i klucz prywatny ze slotu. Kontynuować?',jobQueued:'Zadanie wycofania zostało dodane do kolejki.',operationFailed:'Nie udało się utworzyć zadania.'
  },
  en: {
    ...
    configuration:'CONFIGURATION',consoleSettings:'Console settings',settingsText:'Operator session data and connection information.',operatorAccess:'Operator access',operatorHelp:'The token is stored only in browser session memory. Closing the tab removes it.',operatorToken:'Operator token',enterToken:'Enter token…',saveConnect:'Save and connect',about:'About',aboutText:'Blinky Console · Angular 22 · same-origin API connection.',openSource:'Open source',language:'Language',credentialConsole:'Credential console',actions:'Actions',recycle:'Withdraw and recycle slot',recycleConfirm:'The credential will be withdrawn and the agent will remove its certificate and private key from the slot. Continue?',jobQueued:'The withdrawal job was queued.',operationFailed:'The job could not be created.'
  }
} as const;
